...
//deserialization happens in two ways, json path method, or as method
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void test3(){
        ...
        //we can also use jackson to get the search result
       // Search search2 = response.jsonPath().getObject("", Spartan.class);
    ...
    @DisplayName("Get Request POJO style")
    @Test
    public void test6(){
        ...
        System.out.println(spartan2.getName());
    }
